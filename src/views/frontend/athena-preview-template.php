<?php
/**
 * Summary athena-preview-template.php
 *
 * File responsible for rendering preview template
 *
...
//initiate athena class object
$athenaObj = new \AthenaSearch\AthenaSearchMain();
//get required data:
$athenaDashboardUrl = $athenaObj->getAthenaDashboardFullUrl(). '/preview';
...
if($infiniteScrollStatus == "1") {
    //set data for infinite scroll to array
    ...
    if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
        ...
        //SEND data from php to JS with array that we set above
